...
*/
starter_locations = ["westeurope", "switzerlandnorth"]
...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "abduxukur.abdurixit@swisscom.com"
    ...
    # IP Ranges Primary
    # Regional Address Space: 10.10.0.0/16
    primary_hub_address_space                          = "10.10.0.0/16"
    primary_hub_virtual_network_address_space          = "10.10.0.0/22"
    primary_firewall_subnet_address_prefix             = "10.10.0.0/26"
    primary_firewall_management_subnet_address_prefix  = "10.10.0.192/26"
    ...
    secondary_hub_address_space                          = "10.20.0.0/16"
    secondary_hub_virtual_network_address_space          = "10.20.0.0/22"
    secondary_firewall_subnet_address_prefix             = "10.20.0.0/26"
    secondary_firewall_management_subnet_address_prefix  = "10.20.0.192/26"
    secondary_bastion_subnet_address_prefix              = "10.20.0.64/26"
    secondary_gateway_subnet_address_prefix              = "10.20.0.128/27"
    secondary_private_dns_resolver_subnet_address_prefix = "10.20.0.160/28"
  }
...
management_group_settings = {
  ...
  subscription_placement = {
    identity = {
      ...
      management_group_name = "agileadvant_identity"
    }
    connectivity = {
      subscription_id       = "$${subscription_id_connectivity}"
      management_group_name = "agileadvant_connectivity"
    }
    management = {
      subscription_id       = "$${subscription_id_management}"
      management_group_name = "agileadvant_management"
    }
    security = {
      subscription_id       = "$${subscription_id_security}"
      management_group_name = "agileadvant_security"
    }
  }
...
hub_virtual_networks = {
  primary = {
    ...
    firewall_policy = {
      ...
      network_rule_collection_enabled = true
